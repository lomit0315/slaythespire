# Made by ForgottenArbiter in the inital spirecomm package  https://github.com/ForgottenArbiter/spirecomm/tree/master
...
class SimpleAgent:
    ...
    def get_next_action_in_game(self, game_state):
        ...
        if config["general"]["research"]: # Log the game state even if the agent doesn't generate reasoning for control group tracking
